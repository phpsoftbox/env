...
final class Variables
{
    ...
    public function value(string $key, mixed $default = null): EnvValue
    {
        $normalizedKey = $this->normalizeKey($key);

        return new EnvValue(
            value: $this->variables->get($normalizedKey, $default),
            exists: $this->variables->has($normalizedKey),
        );
    }
